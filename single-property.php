                                    ...
                                    <div class="marcan-property-unit-plan-layout">
                                        ...
                                        <div class="marcan-property-unit-info">
                                            ...
                                            <div class="marcan-property-unit-actions">
                                                <?php if ($unit_quote_url !== '' && $unit_quote_label !== '') : ?>
                                                    <a class="marcan-button-line marcan-button-icon marcan-button-icon-download" href="<?php echo esc_url($unit_quote_url); ?>" target="_blank" rel="noopener"><?php echo esc_html($unit_quote_label); ?></a>
                                                <?php endif; ?>
                                                <?php if ($unit_contact_label !== '') : ?>
                                                    <button class="marcan-button-dark marcan-button-icon marcan-button-icon-arrow" type="button" data-open-contact-modal><?php echo esc_html($unit_contact_label); ?></button>
                                                <?php endif; ?>
                                                <?php if ($unit_share_label !== '') : ?>
                                                    <button class="marcan-button-line marcan-property-unit-share" type="button" data-unit-share data-share-url="<?php echo esc_url($unit_share_url); ?>" data-share-title="<?php echo esc_attr(sprintf(__('Tipología %1$s en %2$s', 'marcan'), $unit_code, $title_plain)); ?>">
                                                        <span><?php echo esc_html($unit_share_label); ?></span>
                                                    </button>
                                                <?php endif; ?>
                                            </div>
                                        </div>
