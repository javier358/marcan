...
$header_menu_attrs = marcan_font_size_attrs(marcan_get_option_font_size('header_menu_label'), 'marcan-menu-button');
...
<header class="marcan-site-header" data-marcan-header style="<?php echo esc_attr($header_styles); ?>">
    ...
    <button<?php echo $header_menu_attrs; ?> type="button" aria-expanded="false" aria-controls="primary-menu" aria-label="<?php echo esc_attr($header_menu_label_plain); ?>" data-menu-toggle>
