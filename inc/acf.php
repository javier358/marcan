...
function marcan_register_field_groups(): void
{
    ...
    marcan_acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            marcan_acf_wysiwyg('field_marcan_related_intro_text', 'Texto antes de relacionados', 'relacionados_intro_texto', 'basic', 0, 'Opcional. Si se deja vacío no se muestra el bloque.'),
            ...
            marcan_acf_tab('field_marcan_tab_prop_single_ctas', 'CTAs single'),
            array('key' => 'field_marcan_single_cta_brochure_label', 'label' => 'Boton brochure', 'name' => 'single_cta_brochure_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
            array('key' => 'field_marcan_single_cta_quote_label', 'label' => 'Boton cotizar', 'name' => 'single_cta_quote_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
            array('key' => 'field_marcan_single_cta_unit_quote_label', 'label' => 'Boton descargar cotizacion', 'name' => 'single_cta_unit_quote_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
            array('key' => 'field_marcan_single_cta_contact_label', 'label' => 'Boton contacto', 'name' => 'single_cta_contact_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
            array('key' => 'field_marcan_single_cta_share_label', 'label' => 'Boton compartir', 'name' => 'single_cta_share_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
            array('key' => 'field_marcan_single_cta_google_label', 'label' => 'Boton Google Maps', 'name' => 'single_cta_google_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
            array('key' => 'field_marcan_single_cta_waze_label', 'label' => 'Boton Waze', 'name' => 'single_cta_waze_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
            array('key' => 'field_marcan_single_price_label', 'label' => 'Etiqueta precio single', 'name' => 'single_price_label', 'type' => 'text', 'wrapper' => array('width' => '50')),
            array('key' => 'field_marcan_single_tours_title', 'label' => 'Titulo recorridos single', 'name' => 'single_tours_title', 'type' => 'text', 'wrapper' => array('width' => '50')),
