...
function marcan_register_field_groups(): void
{
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array('key' => 'field_marcan_footer_complaint_icon', 'label' => 'Ícono Libro de Reclamaciones', 'name' => 'footer_complaint_icon', 'type' => 'image', 'return_format' => 'id', 'preview_size' => 'medium', 'library' => 'all', 'instructions' => 'Ícono del Libro de Reclamaciones (PNG o SVG). Si se deja vacío se usa un ícono por defecto. Enlaza a la página del libro.'),
